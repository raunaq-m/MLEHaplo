##	Script Name: likelihood_singles_set.pl
#	Purpose: Computes the Likelihood of a given set of viral haplotypes chosen from all haplotypes generated by ViPRA 
#	USAGE: perl likelihood_singles_set.pl -set DesiredSet -condgraph CondensedGraphFile -compset CompatibleSetFile -pathsfile ViPRApathsFile  -gl ApproximateGenomeLength -slow -back 
#	DesiredSet: is the name of the haplotypes set for which likelihood needs to be computed. It has to be a subset of haplotype IDs generated by ViPRA. 
#
